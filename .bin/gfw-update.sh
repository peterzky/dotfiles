...
update_list() {
    cat /tmp/gfw_all_domain > $HOME/nixos/nix-config/files/gfw_all_domain
    cat /tmp/china_ip_list  > $HOME/nixos/nix-config/files/china_ip_list
...
diff ~/nixos/nix-config/files/china_ip_list /tmp/china_ip_list
...
diff ~/nixos/nix-config/files/gfw_all_domain /tmp/gfw_all_domain
